    ...
    <div>
      ...
      <div>
        <group title="资产列表">
          ...
          <panel v-show="tabIndex === 0" :footer="footer" :list="rwzcData0" :type="type" @on-click-footer="loadRwzcData" @on-click-item="toZcdetail"></panel>
          <panel v-show="tabIndex === 1" :footer="footer" :list="rwzcData1" :type="type" @on-click-footer="loadRwzcData" @on-click-item="toZcdetail"></panel>
        </group>
      </div>
    </div>
  </div>
...
<script>
  import api from '@/api'
  import { FormPreview, Cell, Group, Panel, Tab, TabItem } from 'vux'
